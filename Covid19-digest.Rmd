...
After looking at global cases and global deaths, I would like to tidy those datasets and put each variable(data, cases, deaths) in their own column.
...
The next step is transforming the data of the global cases
...
global
summary(global)
globalglobal <- global %>% filter(cases>0)
global
summary(global)
...
The next step is handling the US_cases and US_deaths
...
ADD global population data to the cases
...
Data analyzation
```{r data_analyzation, message=FALSE}
